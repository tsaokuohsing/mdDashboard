(function() {
    ...
    /* @ngInject */
    function EventDialogController($scope, $mdDialog, $filter, mddTheming, dialogData, event, edit) {
        ...
        // create colors
        angular.forEach(mddTheming.palettes, function(palette, index) {
            var color = {
                name: index.replace(/-/g, ' '),
                palette: index,
                backgroundColor: mddTheming.rgba(palette['500'].value),
                textColor: mddTheming.rgba(palette['500'].contrast)
            };
