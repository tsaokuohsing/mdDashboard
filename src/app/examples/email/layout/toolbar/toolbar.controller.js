(function() {
    ...
    /* @ngInject */
    function EmailToolbarController($rootScope, $mdMedia, $filter, $mdUtil, $mdSidenav, $state, mddBreadcrumbsService, mddLayout, EMAIL_ROUTES) {
        var vm = this;
        ...
        for(var i = 0; i < EMAIL_ROUTES.length; i++) {
            vm.toolbarMenu.push({
                name: $filter('mddTranslate')(EMAIL_ROUTES[i].name),
