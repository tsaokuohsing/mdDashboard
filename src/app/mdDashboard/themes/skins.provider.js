(function() {
    ...
    angular
        .module('mdDashboard.themes')
        .provider('mddSkins', skinsProvider)
        .run(addSkinToScope);

    /* @ngInject */
    function skinsProvider($mdThemingProvider, mddThemingProvider) {
        var skins = {};
        ...
        return {
            skin: function(id, name) {
                ...
                var skin = new Skin(id, name, $mdThemingProvider, mddThemingProvider);
            ...
            setSkin: function(id) {
                ...
                if(useSkinCookie) {
                    ...
                    var mdDashboardSkin = $cookies.get('mdDashboard-skin');
                    if(angular.isDefined(mdDashboardSkin)) {
                        var cookieTheme = angular.fromJson(mdDashboardSkin);
    ...
    /* @ngInject */
    function Skin(id, name, $mdThemingProvider, mddThemingProvider) {
        ...
        self.loadThemes = function() {
            ...
            for (var element in self.elements) {
                ...
                var theme = mddThemingProvider.theme(self.elements[element]);
    ...
    /* @ngInject */
    function addSkinToScope($rootScope, mddSkins) {
        $rootScope.mddSkin = mddSkins.getCurrent();
    }
})();