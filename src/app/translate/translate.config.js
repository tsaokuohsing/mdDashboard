(function() {
    ...
    angular
        .module('app.custom.translate')
        .config(translateConfig);

    /* @ngInject */
    function translateConfig($translateProvider, $translatePartialLoaderProvider, mddSettingsProvider) {
        var appLanguages = [{
            name: 'Chinese',
            key: 'zh'
        },{
        ...
        // setup available languages in angular translate & mdDashboard
        ...
        for (var language in appLanguages) {
            ...
            // tell mdDashboard that we support this language
            mddSettingsProvider.addLanguage({
